...
export default function LecturePickerModal({ lectureData = [], selected = null, onSave, onClose }) {
    ...
    return (
        ...
        >
            <h4 className='modal__title'>Chọn Giáo Viên</h4>
            {/* Search box */}
            <input
                    ...
                    return (
                        ...
                        >
                            <div className='picker-item__content'>
                                ...
                                <p className='picker-item__content--desc'>{lecture.contractType}</p>
